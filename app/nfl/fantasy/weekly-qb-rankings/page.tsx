...
function NflWeeklyRanking() {
  ...
  return (
    <div className="pagew mx-auto p-5 space-y-4">
      <h1 className="text-2xl text-cblue">Weekly Fantasy Rankings</h1>
      <p className="text-xs">
      ...
      <div className="flex items-center gap-2">
        ...
        {posistions.map((pos) => (
          <button
            ...
            key={pos}
            className={cn("text-xs bg-muted px-3", selectedPos === pos && "bg-cblue text-white")}
          >
            {pos}
          </button>
        ))}
      ...
      <div className="flex items-center gap-2">
        ...
        {teams.map((team) => (
          <button
            ...
            key={team}
            className={cn("text-xs bg-muted px-3", selectedTeam === team && "bg-cblue text-white")}
          >
            {team}
          </button>
        ))}
      ...
      <div className="flex items-center gap-2">
        ...
        {games.map((game) => (
          <button
            ...
            key={game}
            className={cn("text-xs bg-muted px-3", selectedGame === game && "bg-cblue text-white")}
          >
            {game}
          </button>
        ))}
      ...
      <Table className="overflow-x-scroll">
        <TableHeader className="bg-cblue">
          <TableRow>
